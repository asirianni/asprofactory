...
-->
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>/recursos/css/bootstrap-theme.min.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>/recursos/css/fontAwesome.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>/recursos/css/templatemo-style.css">

        <link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700,800,900" rel="stylesheet">

        <script src="<?php echo base_url(); ?>/recursos/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
    <body>
        ...
        <section class="top-part">
          <video controls autoplay loop>
            <source src="<?php echo base_url(); ?>recursos/videos/video.mp4" type="video/mp4">
        ...
        <section class="cd-hero">
          ...
          <div class="cd-slider-nav">
            <nav>
              ...
              <ul>
                <li class="selected"><a href="#0"><div class="image-icon" style="padding-top: 20px;"><img src="<?php echo base_url(); ?>/recursos/img/home-icon.png"></div><h6>Bienvenido</h6></a></li>
                <li><a href="#0"><div class="image-icon" style="padding-top: 20px;"><img src="<?php echo base_url(); ?>/recursos/img/about-icon.png"></div><h6>Nosotros</h6></a></li>
                <li><a href="#0"><div class="image-icon" style="padding-top: 20px;"><img src="<?php echo base_url(); ?>/recursos/img/featured-icon.png"></div><h6>Projectos</h6></a></li>
                <li><a href="#0"><div class="image-icon" style="padding-top: 20px;"><img src="<?php echo base_url(); ?>/recursos/img/projects-icon.png"></div><h6>Demos</h6></a></li>
                <li><a href="#0"><div class="image-icon" style="padding-top: 20px;"><img src="<?php echo base_url(); ?>/recursos/img/contact-icon.png"></div><h6>Contactos</h6></a></li>
              </ul>
            </nav> 
          </div> <!-- .cd-slider-nav -->
                      ...
                      <div class="content second-content">
                        <div class="row">
                          <div class="col-md-7 left-image">
                            <img src="<?php echo base_url(); ?>/recursos/img/left-about-image.jpg">
                          </div>
                          <div class="col-md-5">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-5 right-image">
                            <img src="<?php echo base_url(); ?>/recursos/img/right-about-image.jpg">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="content third-content">
                        <div class="row">
                          <div class="col-md-7 left-image">
                            <img src="<?php echo base_url(); ?>/recursos/img/left-feature-image.png">
                          </div>
                          <div class="col-md-5">
                      ...
                      <div class="content fourth-content">
                        <div class="row">
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-01.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-01.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-02.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-02.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-03.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-03.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-04.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-04.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-05.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-05.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-06.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-06.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-07.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-07.jpg"></a>
                          </div>
                          <div class="col-md-3 project-item">
                            <a href="<?php echo base_url(); ?>/recursos/img/item-08.jpg" data-lightbox="image-1"><img src="<?php echo base_url(); ?>/recursos/img/project-item-08.jpg"></a>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <script src="<?php echo base_url(); ?>/recursos/js/vendor/bootstrap.min.js"></script>
